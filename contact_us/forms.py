...
class ContactForm(forms.Form):
    ...
    first_name = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Names'}),label='',max_length=50,required=True)
    ...
    price_code = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'price code e.g. [0.36KWP - SOLAR]'}),label='',max_length=50,required=True)
